...
Всички пакети се намират в едно атрибутно множество.
`<nixpkgs>` е специална конструкция за път към изтеглените <https://github.com/NixOS/nixpkgs/>.
`with` прави тези пакети свободно достъпни в последвалия израз.
